    ...
    class GUIWindow:
        ...
        def get_entry_data_then_start(self):
            ...
            for entry_object in self.list_of_alternative_entries:
                list_of_alternatives.append(entry_object.get())

            reading_for_votes_object = read_polling.ReadingPollChat(driver=self.bot_core.reading_class.return_driver(),
                                                                    chat_element=self.bot_core.reading_class.get_chat_element())

            polling = threading.Thread(target=reading_for_votes_object.look_for_alternatives_in_chat,
                                       args=[
                                           timer, list_of_alternatives,
